...
export default function Registry({ initialItems, demoMode }: { initialItems: WishlistItem[]; demoMode: boolean }) {
  ...
  return <main>
    ...
    <section className="payment"><div className="qris">QRIS<br/><small>Tambahkan gambar QRIS di sini</small></div><div><h2>Cara patungan</h2><p>1. Pilih wishlist dan isi nominal di formulir.</p><p>2. Transfer melalui QRIS atau rekening yang dicantumkan pengantin.</p><p>3. Pastikan nominal transfer sama dengan yang kamu isi di form, ya.</p></div></section>
